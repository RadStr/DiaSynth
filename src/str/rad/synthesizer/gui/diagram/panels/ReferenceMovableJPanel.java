...
import str.rad.synthesizer.gui.diagram.util.pairs.IntPairWithInternalDoubles;
...
public class ReferenceMovableJPanel extends MovableJPanelBase {
    public ReferenceMovableJPanel(int absoluteX, int absoluteY, int w, int h, DiagramPanel diagramPanel) {
        ...
        location = new IntPairWithInternalDoubles(absoluteX, absoluteY);
    }
    ...
    private IntPairWithInternalDoubles location;
