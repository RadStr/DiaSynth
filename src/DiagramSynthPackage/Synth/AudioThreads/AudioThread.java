...
import DiagramSynthPackage.GUI.PanelAroundMovablePanelsPackage.PlayedWaveVisualizer;
...
public class AudioThread extends Thread implements OutputFormatGetter, AudioControlPanel.VolumeControlGetterIFace {
    ...
    public void setOutputAudioFormat(AudioFormatWithSign newFormat) {
        ...
        int lenExponent = Program.getFirstPowerExponentOfNAfterNumber(sizeInSamples, 2) - 1;
    ...
    public static int convertMsToByteLen(int sampleRate, int frameSize, double msDivFactor) {
        ...
        byteLen = Program.convertToMultipleUp(byteLen, frameSize);
        return byteLen;
    }
