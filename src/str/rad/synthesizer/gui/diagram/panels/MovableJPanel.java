package str.rad.synthesizer.gui.diagram.panels;

import str.rad.synthesizer.gui.diagram.DiagramPanel;
import str.rad.synthesizer.gui.diagram.ifaces.MaxElevationGetterIFace;
import str.rad.synthesizer.gui.diagram.panels.ifaces.LockUpdateIFace;
import str.rad.synthesizer.gui.diagram.panels.ifaces.MovablePanelIFace;
...
import str.rad.synthesizer.gui.diagram.panels.mouse.MovableJPanelMouseAdapter;
import str.rad.synthesizer.gui.diagram.panels.util.color.ColorMover;
import str.rad.synthesizer.gui.diagram.panels.util.color.HSB;
