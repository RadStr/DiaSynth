package str.rad.synthesizer.gui.diagram;

import str.rad.synthesizer.gui.PlayedWaveVisualizer;
import str.rad.synthesizer.gui.diagram.ifaces.ResizeSplitpaneCallbackIFace;
import str.rad.synthesizer.gui.SynthesizerMainPanelIFace;
...
import str.rad.synthesizer.gui.diagram.ifaces.MovingPanelSetterIFace;
import str.rad.synthesizer.gui.diagram.ifaces.ZoomIFace;
import str.rad.synthesizer.gui.diagram.panels.MovableJPanel;
import str.rad.synthesizer.gui.diagram.panels.ReferenceMovableJPanel;
import str.rad.synthesizer.gui.diagram.panels.ifaces.*;
import str.rad.synthesizer.gui.diagram.panels.port.Cable;
import str.rad.synthesizer.gui.diagram.panels.shape.ShapedPanel;
import str.rad.synthesizer.gui.diagram.panels.util.color.ColorPalet;
...
import str.rad.synthesizer.gui.diagram.panels.port.Port;
import str.rad.synthesizer.gui.diagram.util.pairs.IntPairWithInternalDoublesWithMinAndMax;
import str.rad.synthesizer.gui.tree.UnitAdditionIFace;
import str.rad.synthesizer.gui.diagram.util.UnitArrayListSortedByY;
import str.rad.synthesizer.gui.diagram.util.arrow.Arrow;
import str.rad.synthesizer.gui.diagram.util.arrow.ArrowDirection;
import str.rad.synthesizer.synth.*;
import str.rad.synthesizer.synth.audio.AudioRecordingCallback;
import str.rad.synthesizer.synth.audio.AudioThreadWithRecordingSupport;
